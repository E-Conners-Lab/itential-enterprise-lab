...
| 10 | Download Windows Server 2025 eval ISO and virtio-win 0.1.302 to `/srv/images/winserver/` | Microsoft account and eval terms | 7 | manifest 2.7 |
...
| 13 | Download cEOS64-lab 4.35.6M to `/srv/images/ceos/` | Arista account login | 11 | manifest 2.5 |
