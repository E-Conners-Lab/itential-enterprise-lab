...
| `docker.io/ollama/ollama` | - | `0.33.3` (Docker Hub, 2026-09-07) | `0.33.3` | In-lab local models on VM 205, CPU inference; model `qwen2.5:7b` (Ollama library, Q4_K_M, tool calling), pulled by the play into a named volume (ADR 0037, Phase 6) |
...
| node_exporter | v1.12.1 (2026-07-14) | dev-stack `compose.override.yml`, profile `monitoring` | `docker.io/prom/node-exporter:v1.12.1` (Docker Hub 2026-09-10) | [releases](https://github.com/prometheus/node_exporter/releases) | On VM 205 for the dashboard's node panels (job `node_exporter`) |
| process_exporter | 0.8.7 (2025-04-21) | same | `docker.io/ncabatoff/process-exporter:0.8.7` (Docker Hub 2026-09-10) | [releases](https://github.com/ncabatoff/process-exporter/releases) | Groups by the Pronghorn process titles (`itential/process-exporter.yml`) |
| redis_exporter | v1.91.1 (2026-09-07) | same | `docker.io/oliver006/redis_exporter:v1.91.1` (Docker Hub 2026-09-10) | [releases](https://github.com/oliver006/redis_exporter/releases) | job `redis_exporter` |
| mongodb_exporter | 0.53.0 (2026-08-20) | same | `docker.io/percona/mongodb_exporter:0.53.0` (Docker Hub 2026-09-10) | [releases](https://github.com/percona/mongodb_exporter/releases) | job `mongo_exporter`; the dev-stack MongoDB is standalone, so the replica-set panels stay empty |
