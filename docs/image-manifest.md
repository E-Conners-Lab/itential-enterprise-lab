...
| kube-vip | pinned in Phase 3 | static pod manifest | `ghcr.io/kube-vip/kube-vip:<tag>` **UNVERIFIED** this session | | API VIP 10.100.0.19; Phase 3 verifies the tag |
...
| Alloy | 1.19.2 (2026-08-26) | `grafana/alloy` 1.12.1 | `grafana/alloy:v1.19.2` (tag inferred: **UNVERIFIED**) | [releases](https://github.com/grafana/alloy/releases) | Promtail is EOL since 2026-03-02 and not used |
...
| MetalLB, Alloy, Grafana, CNPG, kube-vip image tags | `helm template` / registry check in Phase 3 and 8 |
