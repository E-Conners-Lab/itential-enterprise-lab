...
| 6 | `phase-6/flowai` | FlowAI agents over the topology: Anthropic + in-lab Ollama provider profiles, tools from NetBox/Gateway 5/workflows, agent project as code, ServiceNow Integration Model (ADR 0037); structured CLI output via Genie/TextFSM on a Gateway 5 runner (ADR 0038) | in progress |
